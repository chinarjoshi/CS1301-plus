 ...
 *         - You may not use more than 2 conditionals per method, and you may
 *         only use
 *         them in select methods. Conditionals are if-statements, if-else
 *         statements,
 *         or ternary expressions. The else block associated with an
 *         if-statement does
 *         not count toward this sum.
 *         - You may not use looping constructs in most methods. Looping
 *         constructs
 *         include for loops, while loops and do-while loops. See below for
 *         exceptions
 *         - In those methods that allow looping, you may not use more than 2
 *         looping
 ...
 *         - All methods must be done in one line, except for: zerosCount,
 *         onesCount,
 *         and size.
 *         - Looping and conditionals as described above are only allowed for:
 *         zerosCount, onesCount, and size
 *         - You can only use addition and subtraction in: zerosCount,
 *         onesCount, and
 *         size
 */
